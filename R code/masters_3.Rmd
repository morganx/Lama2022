...
```{r}
 ...
 xcm = subset_samples(rare_xcm, dx != " ")
...
risk_stool = subset_samples(risk_stool,!diagnosis %in% c("", "IC"))
...
NMDS.ord10<- ordinate(kim, "NMDS", "bray")
...
NMDS.ord11<- ordinate(jac, "NMDS", "bray")
...
NMDS.ord14<- ordinate(liu, "NMDS", "bray")
...
#risk<-subset_samples(risk, Antibiotics %in% c("FALSE", "TRUE"))
...
# xcmp<-subset_samples(xcmp, Antibiotics %in% c("no", "yes"))
